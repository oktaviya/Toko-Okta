package com.example.okta.tokooktamakmur;
...
public class MainActivity extends AppCompatActivity {
    private EditText edtnamapel, edtid, edtnamabar, edtjumlahbel, edtharga, edtuangbay;
     ...
     protected void onCreate(Bundle savedInstanceState) {
                  ...
                  getSupportActionBar().setSubtitle("By OKTAVIYANI 15670028");
                 getSupportActionBar().setTitle("Toko OKTA MAKMUR");
                               ...
                               double h = Double.parseDouble(harga);
                                double ub = Double.parseDouble(uangbayar);
                                 ...
                                 txttotalbelanja.setText("Total Belanja : " + total);
                                  ...
                                  if (total >=200000){
                                      txtbonus.setText("Bonus : Sabun");
                                  } else if (total >=4000){
                                      txtbonus.setText("Bonus : Beras");
                                  } else if (total >=18000){
                                      txtbonus.setText("Bonus : Deterjen");
                                  } else if (total >=8000){
                                      txtbonus.setText("Bonus : Telur");
                                  } else if (total >=12000){
